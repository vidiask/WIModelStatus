...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of WIModelStatus.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Vikas Pandey/WIModelStatus'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Vikas Pandey' => 'vikas.pandey.contractor@bbva.com' }
  s.source           = { :git => 'https://github.com/Vikas Pandey/WIModelStatus.git', :tag => s.version.to_s }
